...
cp -r ./env/init_checkpoint/intention_hiding_llm_template/huggingface_model_llama/ checkpoints/redLLM/epoch-0/

python3 checkpoints/redLLM/epoch-0/zero_to_fp32.py \
checkpoints/redLLM/epoch-0/ \
checkpoints/redLLM/epoch-0/huggingface_model_llama/pytorch_model.bin

rm -rf checkpoints/redLLM/epoch-0/epoch-*
